...
namespace Mageplaza\RewardPoints\Plugin\Block\Adminhtml\Order\Creditmemo\Create;

use Magento\Sales\Block\Adminhtml\Order\Creditmemo\Create\Items as CreateItems;
use Mageplaza\RewardPoints\Helper\Data as HelperData;

/**
 * Class Items
 * @package Mageplaza\RewardPoints\Plugin\Block\Adminhtml\Order\Creditmemo\Create
 */
class Items
{
    /**
