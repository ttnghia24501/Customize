    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($feedCollection as $feed) {
            ...
            $creditmemoCollection = $this->creditmemoCollection->create()
                ->addFieldToFilter('created_at', ['gteq' => $feed->getCreatedAt()]);
            $this->objectManager->create(Data::class)->addStoreFilter($invoiceCollection, $storeIds);
            $this->objectManager->create(Data::class)->addStoreFilter($creditmemoCollection, $storeIds);
        ...
        foreach ($collection as $data) {
            ...
            foreach ($items as $item) {
                ...
                foreach ($orderItemFeedKeys as $feedKey) {
                    $feedIds[] = $this->objectManager->create(Data::class)->feedKeyDecode($feedKey);
                }
